...
void Window::savingsButtonWindow()
{
  ...
  savingsAccountNumber = new QLabel(savingsWindow);
  savingsAccountNumber->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  savingsAccountNumber->setText("Account Number:"); // user class function
  savingsAccountNumber->setGeometry(400,50,100,30);


  balanceLabel = new QLabel(savingsWindow);
  balanceLabel->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  balanceLabel->setText("Balance:"); //user function class
...
void Window::checkingsWindow()
{
  ...
  checkingAccountNumber = new QLabel(checkingsWindow);
  checkingAccountNumber->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  checkingAccountNumber->setText("Account Number:"); // user class function
  checkingAccountNumber->setGeometry(400,50,100,30);
  ...
  QLabel * balanceDisplay = new QLabel(checkingsWindow);
  balanceDisplay->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  balanceDisplay->setText("$$$");
  balanceDisplay->setGeometry(490,130,100,30);
...
void Window::depositSavingsWindow()
{
  ...
  savingsAccountNumber = new QLabel(depositSavingsWindow);
  savingsAccountNumber->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  savingsAccountNumber->setText("Account Number:"); // user class function
  savingsAccountNumber->setGeometry(400,50,100,30);


  savingsFunds = new QLabel(depositSavingsWindow);
  savingsFunds->setFrameStyle(QFrame::Panel | QFrame::Sunken);
  savingsFunds->setText("Monetary value:"); // saving class function
  savingsFunds->setGeometry(400,100,100,30);
...
void Window::depositCheckingsWindow()
{
    ...
    checkingsFunds = new QLabel(depositeCheckingsWindow);
    checkingsFunds->setFrameStyle(QFrame::Panel | QFrame::Sunken);
    checkingsFunds->setText("Account Number:"); // user class function
    checkingsFunds->setGeometry(400,50,100,30);


    checkingsFunds = new QLabel(depositeCheckingsWindow);
    checkingsFunds->setFrameStyle(QFrame::Panel | QFrame::Sunken);
    checkingsFunds->setText("Monetary value:"); // saving class function
    checkingsFunds->setGeometry(400,100,100,30);
...
void Window::withdrawCheckingsWindow()
{
    ...
    checkingsFunds = new QLabel(withdrawCheckingsWindow);
    checkingsFunds->setFrameStyle(QFrame::Panel | QFrame::Sunken);
    checkingsFunds->setText("Account Number:"); // user class function
    checkingsFunds->setGeometry(400,50,100,30);
...
void Window::withdrawSavingsWindow()
{
    ...
    savingsAccountNumber = new QLabel(withdrawSavingsWindow);
    savingsAccountNumber->setFrameStyle(QFrame::Panel | QFrame::Sunken);
    savingsAccountNumber->setText("Account Number:"); // user class function
    savingsAccountNumber->setGeometry(400,50,100,30);


    savingsFunds = new QLabel(withdrawSavingsWindow);
    savingsFunds->setFrameStyle(QFrame::Panel | QFrame::Sunken);
    savingsFunds->setText("Monetary value:"); // saving class function
    savingsFunds->setGeometry(400,100,100,30);
